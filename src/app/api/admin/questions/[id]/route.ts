  ...
  try {
    ...
    return NextResponse.json({
      ...
      question: {
        ...
        createdAt: question.createdAt ? question.createdAt.toISOString() : new Date().toISOString(),
        updatedAt: question.updatedAt ? question.updatedAt.toISOString() : new Date().toISOString()
      }
    })
  } catch (error) {
