  ...
  return (
    <LayoutWrapper>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        {/* SEO Meta Tags - AdSense Optimization */}
        <head>
          <title>Blog Saúde Mental | Dicas e Artigos para Bem-Estar Emocional</title>
          <meta name="description" content="Artigos especializados em saúde mental, ansiedade, depressão e bem-estar. Dicas práticas de psicólogos para cuidar da sua saúde mental." />
          <meta name="keywords" content="saúde mental, ansiedade, depressão, bem-estar, psicologia, autoajuda, mindfulness, terapia" />
          <meta name="robots" content="index, follow" />
          <meta property="og:title" content="Blog Saúde Mental | Dicas e Artigos para Bem-Estar Emocional" />
          <meta property="og:description" content="Artigos especializados em saúde mental com dicas práticas de psicólogos." />
          <meta property="og:type" content="website" />
          <meta property="og:image" content="https://mentalsaude.com.br/images/blog-og-image.jpg" />
        </head>
        ...
        <div className="bg-white border-b border-gray-200 py-2">
          <div className="container mx-auto px-4 text-center">
            <div className="bg-gray-100 h-16 flex items-center justify-center text-gray-500 text-sm">
              ...
              Espaço para Anúncio (Header 728x90)
            </div>
          </div>
        </div>
<<<<<<< HEAD
...
>>>>>>> ea77019058fe465d921176d51fea7060fb6ac701
      ...
      <section className="container mx-auto px-4 pb-16">
        <div className="max-w-6xl mx-auto">
          {/* AdSense Middle Ad */}
          <div className="mb-8">
            <div className="bg-gray-100 h-32 flex items-center justify-center text-gray-500 text-sm border border-gray-200 rounded-lg">
              <BookOpen className="h-4 w-4 mr-2" />
              Espaço para Anúncio (Middle 970x250)
            </div>
          </div>
      ...
      {/* AdSense Bottom Ad */}
      <section className="bg-white border-t border-gray-200 py-4">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-gray-100 h-24 flex items-center justify-center text-gray-500 text-sm">
            <BookOpen className="h-4 w-4 mr-2" />
            Espaço para Anúncio (Footer 728x90)
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Guia Completo de Ansiedade</h3>
                  <p className="text-gray-600 text-sm mb-4">Tudo sobre sintomas, causas e tratamentos.</p>
                  <Link href="/blog/guia-ansiedade" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Ler mais →
                  </Link>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Autoestima: Guia Prático</h3>
                  <p className="text-gray-600 text-sm mb-4">Exercícios e técnicas para fortalecer sua autoconfiança.</p>
                  <Link href="/blog/autoestima-guia" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Ler mais →
                  </Link>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-semibold text-gray-900 mb-2">Mindfulness para Iniciantes</h3>
                  <p className="text-gray-600 text-sm mb-4">Passo a passo para começar a meditar hoje mesmo.</p>
                  <Link href="/blog/mindfulness-iniciantes" className="text-blue-600 hover:text-blue-800 text-sm font-medium">
                    Ler mais →
                  </Link>
                </CardContent>
              </Card>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Sobre o Blog Saúde Mental</h2>
            <div className="prose prose-lg text-gray-700">
              <p className="mb-4">
                Bem-vindo ao nosso blog especializado em saúde mental e bem-estar emocional. 
                Aqui você encontrará artigos escritos por psicólogos, terapeutas e especialistas 
                em saúde mental, com informações baseadas em evidências científicas.
              </p>
              <p className="mb-4">
                Nossa missão é democratizar o acesso à informação de qualidade sobre saúde mental, 
                ajudando você a compreender melhor suas emoções, desenvolver estratégias de enfrentamento 
                e saber quando procurar ajuda profissional.
              </p>
              <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Tópicos Abordados</h3>
              <ul className="list-disc pl-6 space-y-2">
                <li>Ansiedade e transtornos de ansiedade</li>
                <li>Depressão e humores depressivos</li>
                <li>Estresse e burnout</li>
                <li>Autoestima e autoconhecimento</li>
                <li>Relacionamentos saudáveis</li>
                <li>Mindfulness e meditação</li>
                <li>Sono e saúde mental</li>
                <li>Alimentação e bem-estar emocional</li>
