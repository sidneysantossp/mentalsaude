...
export default function TestCatalog() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f6ef] text-[#153a36]">
      <header className="mx-auto flex h-20 max-w-[1240px] items-center justify-between px-5 sm:px-8"><Link href="/"><Brand /></Link><Button variant="ghost" className="text-[#0a615a]" onClick={() => setLocation("/")}><ArrowLeft className="mr-2 h-4 w-4" />Voltar ao início</Button></header>
