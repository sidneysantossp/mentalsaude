...
export default function MobileBottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-[#dcebe6] bg-[#fcfcf8]/96 pb-[env(safe-area-inset-bottom)] shadow-[0_-8px_28px_rgba(20,75,67,0.10)] backdrop-blur-xl md:hidden"
    >
